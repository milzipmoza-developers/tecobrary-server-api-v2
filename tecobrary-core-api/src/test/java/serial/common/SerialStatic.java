...
public interface SerialStatic extends LibraryBookStatic {
    ...
    Serial TEST_SERIAL_ALREADY_RENT_03 = new Serial(TEST_SERIAL_INFO_03, TEST_SERIAL_LIBRARY_BOOK_03, TEST_SERIAL_RENT_STATUS_03);
    ...
    Long TEST_SERIAL_NUMBER_07 = 3L;
    Long TEST_BOOK_ID_07 = TEST_LIBRARY_BOOK_ID_02;
    boolean TEST_RENT_STATUS_07 = true;

    SerialInfo TEST_SERIAL_INFO_07 = new SerialInfo(TEST_SERIAL_NUMBER_07);
    SerialLibraryBook TEST_SERIAL_LIBRARY_BOOK_07 = new SerialLibraryBook(TEST_BOOK_ID_07);
    SerialRentStatus TEST_SERIAL_RENT_STATUS_07 = new SerialRentStatus(TEST_RENT_STATUS_07);
    Serial TEST_SERIAL_ALREADY_RENT_07 = new Serial(TEST_SERIAL_INFO_07, TEST_SERIAL_LIBRARY_BOOK_07, TEST_SERIAL_RENT_STATUS_07);
}
