    ...
    <div class="vicp-wrap">
      ...
      <div class="vicp-step1" v-show="step == 1">
        ...
        >
          ...
          <input @change="handleChange" ref="fileinput" type="file" v-if="step == 1" v-show="false">
        </div>
      ...
      <div class="vicp-step3" v-if="step == 3">
        <div class="vicp-upload">
          ...
          <div class="vicp-progress-wrap">
            <span :style="progressStyle" class="vicp-progress" v-show="loading === 1"/>
          </div>
          <div class="vicp-error" v-show="hasError">
            <i class="vicp-icon2"/>
            {{ errorMsg }}
      ...
      <canvas :height="height" :width="width" ref="canvas" v-show="false"/>
    </div>
  </div>
</template>
