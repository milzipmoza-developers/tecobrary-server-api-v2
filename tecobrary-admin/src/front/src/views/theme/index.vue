<template>
  <div class="app-container">
    <el-card class="box-card">
      <div slot="header">
        <a class="link-type link-title"
           href="https://panjiachen.github.io/vue-element-admin-site/guide/advanced/theme.html" target="_blank">
          Theme documentation
        </a>
      </div>
      <div class="box-item">
    ...
    <div class="block">
      <el-tag :key="tag.type" :type="tag.type" class="tag-item" v-for="tag in tags">
        {{ tag.name }}
      </el-tag>
    </div>
