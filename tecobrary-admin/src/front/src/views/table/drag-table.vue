<template>
  <div class="app-container">
    ...
    <el-table :data="list" border fit highlight-current-row ref="dragTable" row-key="id" style="width: 100%"
      ...
      <el-table-column label="Importance" width="100px">
        <template slot-scope="{row}">
          <svg-icon :key="n" class="icon-star" icon-class="star" v-for="n in + row.importance"/>
        </template>
      </el-table-column>
